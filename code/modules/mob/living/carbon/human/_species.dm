...
/proc/generate_selectable_species_and_languages()
	...
	GLOB.uncommon_roundstart_languages += /datum/language/nekomimetic // honk - languages for disabled species
	GLOB.uncommon_roundstart_languages += /datum/language/kitsumimetic // honk - languages for disabled species
