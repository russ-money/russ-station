...
/proc/create_consistent_human_dna(mob/living/carbon/human/target)
	...
	target.dna.features["diona_hair"] = get_consistent_feature_entry(SSaccessories.diona_hair_list) // honk diona
	target.dna.features["tail_kitsune"] = get_consistent_feature_entry(SSaccessories.tails_list_skaven) // honk fox
	target.dna.features["tail_skaven"] = get_consistent_feature_entry(SSaccessories.tails_list_kitsune) // honk rat
