...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("compost bin", /obj/machinery/portable_atmospherics/canister/compost_bin, 10, time = 1.5 SECONDS, crafting_flags = CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_MISC), \
	//honk end
