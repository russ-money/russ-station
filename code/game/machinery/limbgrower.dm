...
/obj/machinery/limbgrower
	...
	var/list/categories = list(SPECIES_HUMAN, SPECIES_LIZARD, SPECIES_MOTH, SPECIES_PLASMAMAN, SPECIES_ETHEREAL, RND_CATEGORY_LIMBS_OTHER, RND_CATEGORY_LIMBS_DIGITIGRADE, SPECIES_SKAVEN, SPECIES_KITSUNE) //honk -- Adds SPECIES_SKAVEN and SPECIES_KITSUNE
