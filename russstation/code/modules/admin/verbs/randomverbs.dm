ADMIN_VERB(show_tip, R_ADMIN, "Honk", "Honk Smite.", ADMIN_CATEGORY_FUN)
...
ADMIN_VERB(show_tip, R_ADMIN, "Force Cancel Shuttle", "Forcefully cancels shuttle.", ADMIN_CATEGORY_MAIN)
