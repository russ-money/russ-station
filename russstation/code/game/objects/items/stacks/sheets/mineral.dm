...
GLOBAL_LIST_INIT(clay_recipes, list(
	...
	new /datum/stack_recipe("sand", /obj/item/stack/ore/glass, req_amount=1, crafting_flags = CRAFT_ON_SOLID_GROUND) \
	))
...
GLOBAL_LIST_INIT(stone_recipes, list( \
	new /datum/stack_recipe("Stone bed", /obj/structure/bed/stone, 3, time = 15, crafting_flags = CRAFT_ON_SOLID_GROUND | CRAFT_ONE_PER_TURF), \
	new /datum/stack_recipe("Stone table frame", /obj/structure/table_frame/stone, 4, time = 15, crafting_flags = CRAFT_ON_SOLID_GROUND | CRAFT_ONE_PER_TURF), \
	new /datum/stack_recipe("Stone throne", /obj/structure/chair/stone, 2, time = 10, crafting_flags = CRAFT_ON_SOLID_GROUND | CRAFT_ONE_PER_TURF), \
	new /datum/stack_recipe("Stone door", /obj/structure/mineral_door/stone, 20, time = 30, crafting_flags = CRAFT_ON_SOLID_GROUND | CRAFT_ONE_PER_TURF), \
	new /datum/stack_recipe("Stone coffer", /obj/structure/closet/crate/stone, 3, time = 15, crafting_flags = CRAFT_ON_SOLID_GROUND | CRAFT_ONE_PER_TURF), \
	new /datum/stack_recipe("Stone floor tiles", /obj/item/stack/tile/stone, 1, 4, 20), \
	new /datum/stack_recipe("Stone wall frame", /obj/structure/girder/stone, 4, time = 40, crafting_flags = CRAFT_ON_SOLID_GROUND | CRAFT_ONE_PER_TURF), \
	new /datum/stack_recipe("Stone window", /obj/structure/stone_window, 5, time = 15, crafting_flags = CRAFT_ON_SOLID_GROUND | CRAFT_ONE_PER_TURF), \
	new /datum/stack_recipe("Carving block", /obj/structure/carving_block, 5, time = 5, crafting_flags = CRAFT_ON_SOLID_GROUND | CRAFT_ONE_PER_TURF | CRAFT_APPLIES_MATS) \
	))
